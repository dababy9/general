...
class SPLTestBase {
    ...
    protected void interpreterError(Executable action) {
        MockInterpreter interp = new MockInterpreter("", List.of());
        assertThrows(MockInterpreter.Error.class, action);
    }
}
